...
--
-- Different question from the loaded-vehicle journey test that used
-- to sit above this (removed -- its question, Bug A: does an ALREADY-
-- LOADED vehicle keep/lose its existing cargo, was answered live and
-- documented in DECISIONS.md). This one starts from a CONFIRMED-EMPTY
-- vehicle (mirroring exactly
